...
def get_dv(start=20170101, end=20180101):
    ...
    # define
    factor_list = ['total_share','oper_profit','oper_rev','OperatingRevenueGrowRate']
...
from tamplate import alpha42,alpha49,alpha115,alpha144,alpha183,OperatingProfitPS,Price1M,OperatingRevenueGrowRate5Y

for f in ['alpha42','alpha49','alpha115','alpha144','alpha183','OperatingProfitPS','Price1M','OperatingRevenueGrowRate5Y']:
